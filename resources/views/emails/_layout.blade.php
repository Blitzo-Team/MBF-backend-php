...
<body width="100%" style="margin: 0; mso-line-height-rule: exactly;">
    <center style="width: 100%; text-align: left;">
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            <tr>
                <td style="padding: 20px 0px 30px 0px; text-align: center">
                    <!-- {{ $base_url }}/images/ched_logo.png -->
                    <!--
                    <img src="https://www1.pagasa.dost.gov.ph/images/about-pagasa/pagasa-logo.jpg" width="130" height="130" alt="LOGO" border="0" style="height: auto; font-family: sans-serif; font-size: 15px; line-height: 140%;"> 
                    -->
                </td>
            </tr>
        </table>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 0; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555; text-align: left;">
                    <p style="margin: 0;">
                        @yield('content')
                    </p>
                </td>
        ...
        <tr>
            ...
            <td bgcolor="#666666" valign="middle" style="text-align: center; background-position: center center !important; background-size: cover !important;">
                <!--[if gte mso 9]>
                        ...
                        <tr>
                            <td valign="middle" style="text-align: center; padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #ffffff;">
                                <p style="margin: 0;">
                                    <!--
                                    CHED PCARI <br />
                                    Higher Education Development Center (HEDC) Bldg., <br />
                                    C.P. Garcia Ave., UP Campus, Diliman, Quezon City <br />
                                    +632 352 5591 | +632 376 1758 <br />
                                    -->
                                </p>
                            </td>
                        </tr>
